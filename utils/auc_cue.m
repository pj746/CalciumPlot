function [auc_result, neuron] = auc_cue(data,neuron,auc_thresh,filefolder,filelist,varargin)
...
for iintruder = 1:nintruder
    ...
    %     zerostate = zerostates>0;
        ...
        parfor icell = 1:num_neuron
            ...
            [aucs(icell, istate, iintruder), pvals(icell, istate, iintruder), ~] = auROC_withStates(timeseries,behavioralstate,zerostates(iintruder,:),100,5000);
